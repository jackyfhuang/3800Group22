...
export function ChildImageCard({ child, onCapture }: Props) {
  ...
  const poster = (
    <View style={styles.posterRoot}>
      <View style={styles.header}>
        <View>
          <AppText style={styles.title}>Child Safety Image</AppText>
        ...
        <View style={styles.actions}>
          ...
          >
            {capturing ? (
              ...
              <AppText style={styles.primaryBtnText}>Share Image</AppText>
            )}
          </TouchableOpacity>
