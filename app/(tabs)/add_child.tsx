...
const childSchema = z.object({
  ...
  height:      z.preprocess(v => parseFloat(String(v)), z.number().min(30, 'Height (cm) seems too low').max(250, 'Height seems too high')),
  weight:      z.preprocess(v => parseFloat(String(v)), z.number().min(2, 'Weight (kg) seems too low')),
...
export default function AddChildScreen() {
      ...
      <FormSection title="Identity" subtitle="All fields required">
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <AppText style={dateOfBirth ? styles.datePickerText : styles.datePickerPlaceholder}>
              {dateOfBirth || 'Select date of birth'}
            </AppText>
            <MaterialIcons name="calendar-month" size={22} color={colors.textSubtle} style={{ marginLeft: 8 }} />
          </TouchableOpacity>
          {errors.dateOfBirth && (
        ...
        {/* Sex dropdown */}
        <AppDropdown control={control} name="sex" label="Sex"
          options={SEX_OPTIONS} placeholder="Select sex"
          error={errors.sex?.message} />

        {/* Ethnicity — free text */}
        <FormField control={control} name="ethnicity" label="Ethnicity"
  ...
  const renderStep2 = () => (
    <FormSection title="Medical Info" subtitle="All fields optional">
      ...
      <AppDropdown control={control} name="communicationNeeds"
        label="Communication Needs" options={COMMUNICATION_OPTIONS}
        placeholder="Select" />
  ...
  const renderStep3 = () => (
    <>
      <FormSection title="Primary Guardian 1" subtitle="Name, phone and address required">
      ...
      <FormSection title="Additional Emergency Contacts"
        ...
        {fields.map((field, index) => (
          <View key={field.id} style={styles.contactCard}>
            ...
            <FormField control={control}
              ...
              label="Relationship" placeholder="e.g. Aunt, Family Friend"
  ...
  const renderStep4 = () => (
    <>
      <FormSection title="Hair & Eyes" subtitle="Eye and hair color required">
        <View style={styles.row}>
          <View style={{ flex: 1 }}>
            ...
            {eyeColor === 'other' && (
              <FormField control={control} name="eyeColorOther"
                label="Describe Eye Color" placeholder="Enter eye color" />
            )}
          </View>
          <View style={{ flex: 1 }}>
            ...
            {hairColor === 'other' && (
              <FormField control={control} name="hairColorOther"
                label="Describe Hair Color" placeholder="Enter hair color" />
            )}
          </View>
        </View>
      ...
      <FormSection title="Clothing" subtitle="All optional">
        ...
        <FormField control={control} name="topColor" label="Top / Shirt"
          placeholder="e.g. Blue hoodie, white t-shirt" />
        <FormField control={control} name="pantsColor" label="Pants / Bottom"
